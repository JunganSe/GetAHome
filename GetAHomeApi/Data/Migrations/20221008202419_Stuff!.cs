        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BeeArea = table.Column<double>(type: "REAL", nullable: false),
                    ...
                    ViewingDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    AddressId = table.Column<int>(type: "INTEGER", nullable: false),
                    ResidenceTypeId = table.Column<int>(type: "INTEGER", nullable: false),
                    TenureId = table.Column<int>(type: "INTEGER", nullable: false),
                    SaleStatusId = table.Column<int>(type: "INTEGER", nullable: false),
                    EstateAgentId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Residences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Residences_Adresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Adresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Residences_AspNetUsers_EstateAgentId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Residences_SaleStatuses_SaleStatusId",
                        column: x => x.SaleStatusId,
                        principalTable: "SaleStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Residences_Tenures_TenureId",
                        column: x => x.TenureId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpressionOfInterests", x => new { x.AppUserId, x.ResidenceId });
                    table.ForeignKey(
                        name: "FK_ExpressionOfInterests_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpressionOfInterests_Residences_ResidenceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDisplayImage = table.Column<bool>(type: "INTEGER", nullable: false),
                    ResidenceId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_Residences_ResidenceId",
                        column: x => x.ResidenceId,
                        principalTable: "Residences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpressionOfInterests_ResidenceId",
                table: "ExpressionOfInterests",
                column: "ResidenceId");

            migrationBuilder.CreateIndex(
                name: "IX_Images_ResidenceId",
                table: "Images",
                column: "ResidenceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Residences_EstateAgentId",
                table: "Residences",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Residences_SaleStatusId",
                table: "Residences",
                column: "SaleStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Residences_TenureId",
                table: "Residences",
                column: "TenureId");
        }
